                ...
                filteredLeads.map((lead) => {
                  ...
                  return (
                    <tr key={lead.id} className="border-t border-gray-100 hover:bg-yellow-50/40">
                      ...
                      <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{formatStatus(lead.plan || "None")}</td>
                      <td className="px-4 py-3 text-gray-500 whitespace-nowrap">{formatDate(lead.lead_date || lead.created_at)}</td>
                      <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{lead.assigned_to_name || lead.assigned_to || "Unassigned"}</td>
                      <td className="px-4 py-3 whitespace-nowrap">
